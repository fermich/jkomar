/*
 * $Id: DowCellRenderer.java,v 1.2 2007/06/16 09:03:05 fermich Exp $
 */
...
class DowCellRenderer extends JPanel implements ListCellRenderer {
    ...
    public Component getListCellRendererComponent(
        ...
        fileLabel = ((FilePacketWriter) value).getFileLabel();
        progres = ((FilePacketWriter) value).getProgressBar();
